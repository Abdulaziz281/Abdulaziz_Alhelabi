...
if(isset($_POST["update"])){
    ...
    $picture=$_POST["picture"];
        ...
        $sql="UPDATE `pets` SET `name`='$name',`picture`='$picture',`location`='$location',`description`='$description',`size`='$size',`age`='$age',`vaccination`='$vaccination',`breed`='$breed' WHERE id=$id";
       $result=mysqli_query($connect,$sql);
    ...
    <div class="container mt-5">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control"value="<?= $row["vaccination"] ?>" id="vaccination" aria-describedby="vaccination" name="vaccination">
            </div>
            <div class="mb-3">
